...
namespace MVCIdentityConfirm.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.UserName ,DateOfBirth=model.DateOfBirth,Address=model.Address};
                ...
                if (result.Succeeded)
                {
                    System.Net.Mail.MailMessage m = new System.Net.Mail.MailMessage(new System.Net.Mail.MailAddress("raj@promactinfo.com", "Web Registration"),
                    ...
                    smtp.Credentials = new System.Net.NetworkCredential("raj@promactinfo.com", "EDajOeKH*fYE7XWs");
